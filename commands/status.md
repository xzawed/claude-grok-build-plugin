...
5. **Usage:** `usageHeadline`, success/subscription rates when present
6. **Last session:** `lastSession.sessionId` if any → mention `/grok:resume`
7. **Next:** follow `nextSteps` (do not invent IDs or skip billing)
