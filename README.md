...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) ![Tests](https://img.shields.io/badge/tests-111%20passing-brightgreen.svg) ![TypeScript](https://img.shields.io/badge/TypeScript-ESM-3178C6.svg) ![Status](https://img.shields.io/badge/status-Phases%201--3%20complete-success.svg)
...
Under the hood, `mcp-server/` (TypeScript, ESM) ships six MCP tools over stdio — `grok_auth_check`, `grok_build_delegate` (worktree/sandbox isolation), `grok_build_plan`, `grok_build_verify`, `grok_build_usage`, and `grok_cli` — plus a PreToolUse auth-check hook. 111 unit tests; prebuilt bundles are committed.
