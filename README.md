...
**In-repo scope is complete (v0.2.8).** External Task Manager wiring lives in consumer repos; Claude Code GUI clicks are a manual release checklist; ACP is deferred. See [`docs/09-scope-and-residuals.md`](docs/09-scope-and-residuals.md) and [`docs/06-roadmap.md`](docs/06-roadmap.md).
</details>
